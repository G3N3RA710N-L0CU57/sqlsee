...
class Iterator(HTTPrequest):
    ...
    def __init__(self, url, header, data=None, query):
...
parser.add_argument("-fE", "--first-esc", help="First escape character used in query. ex. -fE '")
parser.add_argument("-lE", "--last-esc", help="Last escape character used in query, usually a comment. ex. -- -")
